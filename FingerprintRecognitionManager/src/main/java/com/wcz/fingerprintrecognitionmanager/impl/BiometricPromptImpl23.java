...
public class BiometricPromptImpl23 implements IBiometricPrompt {
    ...
    public BiometricPromptImpl23(ComponentActivity activity, BaseFingerDialog fingerDialog,
    ...
    public void authenticate(@NonNull final CancellationSignal cancel) {
        ...
        if (!mFingerDialog.isAdded()) {
            //mFingerDialog.show(mActivity.getFragmentManager().beginTransaction(), mFingerDialog.getClass().getSimpleName());
        }
        //开始指纹认证
